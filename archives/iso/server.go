...
// func (s *TCPServer) GetString(section string, key string, defValue string) string {
// 	if s.Config.Section(section).HasKey(key) {
// 		return s.Config.Section(section).Key(key).String()
// 	}
// 	return defValue
// }

// // GetInt from config
// func (s *TCPServer) GetInt(section string, key string, defValue int) int {
// 	if s.Config.Section(section).HasKey(key) {
// 		val, e := s.Config.Section(section).Key(key).Int()
// 		if e == nil {
// 			return val
// 		}
// 	}
