...
func (m *IsoMessage) Bytes(withLength bool) ([]byte, error) {
	data := ""
...
// Load from stream
func (m *IsoMessage) Load(source []byte, hasLength bool) error {
	if len(source) < 24 {
...
func (m *IsoMessage) buildValues(source []byte, bitmapHex string, bitmaps []int, offset int) error {
